  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          Why Filipino Skin Needs <span className="text-primary">Volcanic Clay</span>
        </h2>
        ...
        >
          <p className="text-lg text-foreground/80">Complete volcanic skincare solution for tropical Filipino skin</p>
        </div>
      </div>
    </section>
  )
