...
export function ReviewsSection() {
  ...
  return (
    <section ref={sectionRef} id="reviews" className="py-16 sm:py-24 bg-background px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          >
            ...
            <span className="text-foreground/70">(10,000+ Reviews)</span>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {reviews.map((review, idx) => (
            <div
              key={review.id}
              className={`rounded-xl bg-card border border-border/50 p-6 sm:p-8 hover:border-primary/50 transition-all duration-300 ${isVisible ? "animate-fade-in-up" : "opacity-0"}`}
